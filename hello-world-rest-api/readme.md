...
- Main class com.neuro.rest.webservices.restfulwebservices.RestfulWebServicesApplication 
...
- http://localhost:8200/hello-world/path-variable/neuro

```json
{"message":"Hello World, neuro"}
```
